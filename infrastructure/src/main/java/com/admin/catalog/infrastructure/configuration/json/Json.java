package com.admin.catalog.infrastructure.configuration.json;
...
public enum Json {
    ...
    private final ObjectMapper mapper = new Jackson2ObjectMapperBuilder()
        ...
        .featuresToDisable(
            FAIL_ON_UNKNOWN_PROPERTIES, FAIL_ON_NULL_FOR_PRIMITIVES,
            FAIL_ON_NULL_CREATOR_PROPERTIES, WRITE_DATES_AS_TIMESTAMPS)
